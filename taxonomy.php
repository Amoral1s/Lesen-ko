  ...
  <div class="container">
    <div class="cat-page-offer-wrap">
      <div class="left">
        ...
        <div class="btns">
          <div class="button buy-stair"  data-link="Это страница категории" data-title="<?php the_field('offer_title', $term); ?>">
            Бесплатный расчёт
          </div>
          <div class="price">
        ...
        <?php
          ...
          if ($offer_img) {
              if ($offer_img['alt']) {
                ...
                echo '<img src="' . esc_url($offer_img['url']) . '" alt="' . get_field('offer_title', $term) . '">'; // Выводим изображение
              }
          }
        ?>
      </div>
